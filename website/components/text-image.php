<div class="container md:flex">
  ...
  <img src="images/riccardo-chiarini-365677-unsplash.jpg"
     srcset="images/riccardo-chiarini-365677-unsplash@2x.jpg 2x,
             images/riccardo-chiarini-365677-unsplash@3x.jpg 3x"
     class="inline">
  </div>
  <div class="md:order-first md:w-1/2 mt-4 lg:px-8 xl:px-12">
    <h2 class="text-blue text-3xl sm:text-4xl md:text-4xl xl:text-6xl">Here is a title</h2>
    <div class="font-sb text-xl mt-4 tracking-wider">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas eget nisi a dui porttitor posuere.</div>
